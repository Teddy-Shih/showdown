...
/**
 * OUBattleSimulator - Run battles in Gen 9 OU format with custom teams
 */
class OUBattleSimulator {
  constructor(bot1, bot2, team1, team2, options = {}) {
    this.bot1 = bot1;
    this.bot2 = bot2;
    this.team1 = team1; // Team string in Showdown format
    this.team2 = team2; // Team string in Showdown format
...
module.exports = OUBattleSimulator;

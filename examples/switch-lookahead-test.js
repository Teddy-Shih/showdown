...
async function main() {
  ...
  console.log('TYPEAWAREBOT: PURE BOOST PROPAGATION (NO HEURISTICS)');
  console.log('='.repeat(80));
  console.log();
  console.log('🆕 IMPLEMENTATION:');
  console.log('   - Correct boost propagation (AFTER current, BEFORE next turn) ✓');
  console.log('   - NO heuristic bonuses - pure minimax evaluation');
  console.log('   - Search depth: 4 plies');
  console.log('   - Setup moves simulated naturally through search');
  console.log();
